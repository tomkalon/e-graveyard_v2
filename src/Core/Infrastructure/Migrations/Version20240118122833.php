 ...
 */
final class Version20240118122833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE file ADD type VARCHAR(255) DEFAULT NULL, ADD discr VARCHAR(255) NOT NULL, DROP grave_id, DROP graveyard_id, DROP `primary`');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE file ADD grave_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD graveyard_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', ADD `primary` TINYINT(1) DEFAULT NULL, DROP type, DROP discr');
    }
}
