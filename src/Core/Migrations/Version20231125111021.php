 ...
 */
final class Version20231125111021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE file CHANGE id id VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE grave CHANGE id id VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE students_images (image_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', student_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_5AC39B083DA5256D (image_id), INDEX IDX_5AC39B08CB944F1A (student_id), PRIMARY KEY(image_id, student_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE grave_images (student_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', image_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_20865583CB944F1A (student_id), INDEX IDX_208655833DA5256D (image_id), PRIMARY KEY(student_id, image_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE grave CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\'');
